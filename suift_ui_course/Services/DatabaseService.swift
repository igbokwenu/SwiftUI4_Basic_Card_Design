...
struct Database {
    func getData() -> [CardItem] {
        ...
        return [
            ...
            //If you want to add CardItem for a new series eg tarzan, add it below this line, then copy and paste it after your last CardItem. Do not forget to add your image in the Assets folder and reference it properly in the imageString. happy coding!
        ]
    }
}
